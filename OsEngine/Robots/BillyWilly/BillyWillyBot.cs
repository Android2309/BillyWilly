...
namespace OsEngine.Robots.BillyWilly
{
    public class BillyWillyBot : BotPanel
    {
        /// <summary>
        /// tab to trade
        ...
        public BillyWillyBot(string name, StartProgram startProgram) : base(name, startProgram)
        {
            ...
            ParametrsChangeByUser += Strategy_ParametrsChangeByUser;
        }
        /// <summary>
        /// Parameters changed by user
        /// параметры изменены юзером
        /// </summary>
        void Strategy_ParametrsChangeByUser()
        {
        ...
        {
            return "BillyWillyBot";
        }

        public override void ShowIndividualSettingsDialog()
        {
            MessageBox.Show("Хер знает");
        }
